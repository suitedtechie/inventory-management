...
-- AddForeignKey
ALTER TABLE "CompanyWorkspace" ADD CONSTRAINT "CompanyWorkspace_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "Resource"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
